...
export default function SortDropdown({
    ...
    const title =
        mode === "server" ? "Server-side sort" : "Client-side sort";
            ...
            {isOpen && (
                <div className="sort-dropdown-menu">
                    ...
                    <button
                        type="button"
                        onClick={() => onSort?.("asc")}
                        className={`sort-dropdown-option ${activeSort && sortDirection === "asc" ? "active" : ""
                            }`}
                    >
                    ...
                    <button
                        type="button"
                        onClick={() => onSort?.("desc")}
                        className={`sort-dropdown-option ${activeSort && sortDirection === "desc" ? "active" : ""
                            }`}
                    >
