...
const JOBVACATION_API =
  import.meta.env.VITE_JOBVACATION_API || import.meta.env.VITE_BASE_URL;

if (!JOBVACATION_API) {
  throw new Error(
    "Missing VITE_JOBVACATION_API or VITE_BASE_URL environment variable",
  );
}
